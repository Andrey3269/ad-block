...
window.rch_nws[hostkey].Registry = function RchRegistry(client, startConnection) {
  ...
  function startPlugin() {
    ...
    // Штатную кнопку «Смотреть» не перехватываем: в разных сборках Lampa
    // она может открывать трейлеры или другой встроенный источник. BwaRC
    // остаётся отдельным явным пунктом «Онлайн» и контекстным действием.
